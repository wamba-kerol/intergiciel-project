...
//                 id="coef"
//                 name="coef"
//                 value={courseForm.coef}
//                 onChange={(e) => setCourseForm({ ...courseForm, coef: parseInt(e.target.value) })}
//                 className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-800 focus:border-blue-800"
//                 required
//                 min="1"
//               />
...
//                   <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">coeffiscient</th>
//                 </tr>
//               </thead>
//               <tbody className="bg-white divide-y divide-gray-200">
//                 {courses.map((course) => (
...
//                     <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{course.coef}</td>
//                   </tr>
//                 ))}
//                 {courses.length === 0 && (
//                   <tr>
